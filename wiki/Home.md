...
The wiki itself is actually a git repository, <br> which means you can clone it, edit it locally/offline, add images or any other file type, and push it back to us. It will be live immediately.

Go ahead and try:

```
$ git clone https://GreyMerlin@bitbucket.org/GreyMerlin/winmerge-document-testing.git/wiki
```
